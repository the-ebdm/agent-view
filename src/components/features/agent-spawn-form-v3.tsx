/**
 * Enhanced Agent Spawn Form (V3)
 * Includes templates, recent agents, configurations, and improved UX
 */
'use client';
...
interface AgentSpawnFormV3Props {
  onSpawn?: (agentId: string) => void;
  collapsed?: boolean;
  onToggleCollapse?: () => void;
}

export function AgentSpawnFormV3({ onSpawn, collapsed, onToggleCollapse }: AgentSpawnFormV3Props) {
  ...
  return (
    <Card>
      ...
      <div className="p-3 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-sm">Spawn New Agent</h3>
          </div>
          {onToggleCollapse && (
            <button
            ...
            <div className="grid grid-cols-1 gap-2">
              {filteredTemplates.map((template) => (
                <button
                  ...
                  className="group text-left p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all"
                >
                  <div className="flex items-center gap-2">
      ...
      {/* Main Form */}
      <form onSubmit={handleSubmit} className="p-3 space-y-3 border-t border-gray-200 dark:border-gray-700">
        {/* Agent Name */}
        <div>
