/**
 * Agent Spawn Modal V2 - Collapsible Sections
...
interface AgentSpawnModalV2Props {
  isOpen: boolean;
  onClose: () => void;
...
export function AgentSpawnModalV2({ isOpen, onClose, onSpawn, defaultDirectory }: AgentSpawnModalV2Props) {
